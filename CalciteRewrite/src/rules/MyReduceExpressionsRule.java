...
/**
 * Collection of planner rewriter.rules that apply various simplifying transformations on
 ...
 */
public abstract class MyReduceExpressionsRule<C extends MyReduceExpressionsRule.Config>
        extends RelRule<C>
     ...
     * it to prevent the planner from invoking these rewriter.rules.
     */
     ...
     */
    public static class MyFilterReduceExpressionsRule
            extends MyReduceExpressionsRule<MyFilterReduceExpressionsRule.MyFilterReduceExpressionsRuleConfig> {
        /** Creates a MyFilterReduceExpressionsRule. */
        protected MyFilterReduceExpressionsRule(MyFilterReduceExpressionsRuleConfig config) {
            super(config);
        }

        @Deprecated // to be removed before 2.0
        public MyFilterReduceExpressionsRule(Class<? extends Filter> filterClass,
                                           RelBuilderFactory relBuilderFactory) {
            this(MyFilterReduceExpressionsRuleConfig.DEFAULT.withRelBuilderFactory(relBuilderFactory)
                    .as(MyFilterReduceExpressionsRuleConfig.class)
        ...
        /** Rule configuration. */
        @Value.Immutable
        public interface MyFilterReduceExpressionsRuleConfig extends MyReduceExpressionsRule.Config {
            MyFilterReduceExpressionsRuleConfig DEFAULT = ImmutableMyFilterReduceExpressionsRuleConfig.of()
                    .withMatchNullability(true)
                    .withOperandFor(LogicalFilter.class)
                    .withDescription("ReduceExpressionsRule(Filter)")
                    .as(MyFilterReduceExpressionsRuleConfig.class);

            @Override default MyFilterReduceExpressionsRule toRule() {
                return new MyFilterReduceExpressionsRule(this);
            }
        }
    }
    ...
    public static class MyProjectReduceExpressionsRule
            extends MyReduceExpressionsRule<
            MyProjectReduceExpressionsRule.MyProjectReduceExpressionsRuleConfig> {
        /** Creates a MyProjectReduceExpressionsRule. */
        protected MyProjectReduceExpressionsRule(MyProjectReduceExpressionsRuleConfig config) {
            super(config);
        }

        @Deprecated // to be removed before 2.0
        public MyProjectReduceExpressionsRule(Class<? extends Project> projectClass,
                                            RelBuilderFactory relBuilderFactory) {
            this(MyProjectReduceExpressionsRuleConfig.DEFAULT.withRelBuilderFactory(relBuilderFactory)
                    .as(MyProjectReduceExpressionsRuleConfig.class)
        ...
        /** Rule configuration. */
        @Value.Immutable
        public interface MyProjectReduceExpressionsRuleConfig extends MyReduceExpressionsRule.Config {
            MyProjectReduceExpressionsRuleConfig DEFAULT = ImmutableMyProjectReduceExpressionsRuleConfig.of()
                    .withMatchNullability(true)
                    .withOperandFor(LogicalProject.class)
                    .withDescription("ReduceExpressionsRule(Project)")
                    .as(MyProjectReduceExpressionsRuleConfig.class);

            @Override default MyProjectReduceExpressionsRule toRule() {
                return new MyProjectReduceExpressionsRule(this);
            }
        }
    }

    /** Rule that reduces constants inside a {@link Join}.*/
    public static class MyJoinReduceExpressionsRule
            extends MyReduceExpressionsRule<MyJoinReduceExpressionsRule.MyJoinReduceExpressionsRuleConfig> {
        /** Creates a MyJoinReduceExpressionsRule. */
        protected MyJoinReduceExpressionsRule(MyJoinReduceExpressionsRuleConfig config) {
            super(config);
        }

        @Deprecated // to be removed before 2.0
        public MyJoinReduceExpressionsRule(Class<? extends Join> joinClass,
                                         RelBuilderFactory relBuilderFactory) {
            this(MyJoinReduceExpressionsRuleConfig.DEFAULT.withRelBuilderFactory(relBuilderFactory)
                    .as(MyJoinReduceExpressionsRuleConfig.class)
        ...
        /** Rule configuration. */
        @Value.Immutable
        public interface MyJoinReduceExpressionsRuleConfig extends MyReduceExpressionsRule.Config {
            MyJoinReduceExpressionsRuleConfig DEFAULT = ImmutableMyJoinReduceExpressionsRuleConfig.of()
                    .withMatchNullability(false)
                    .withOperandFor(Join.class)
                    .withDescription("ReduceExpressionsRule(Join)")
                    .as(MyJoinReduceExpressionsRuleConfig.class);

            @Override default MyJoinReduceExpressionsRule toRule() {
                return new MyJoinReduceExpressionsRule(this);
            }
        }
    }
     ...
     */
    public static class MyCalcReduceExpressionsRule
            extends MyReduceExpressionsRule<MyCalcReduceExpressionsRule.MyCalcReduceExpressionsRuleConfig> {
        /** Creates a MyCalcReduceExpressionsRule. */
        protected MyCalcReduceExpressionsRule(MyCalcReduceExpressionsRuleConfig config) {
            super(config);
        }

        @Deprecated // to be removed before 2.0
        public MyCalcReduceExpressionsRule(Class<? extends Calc> calcClass,
                                         RelBuilderFactory relBuilderFactory) {
            this(MyCalcReduceExpressionsRuleConfig.DEFAULT.withRelBuilderFactory(relBuilderFactory)
                    .as(MyCalcReduceExpressionsRuleConfig.class)
        ...
        /** Rule configuration. */
        @Value.Immutable
        public interface MyCalcReduceExpressionsRuleConfig extends MyReduceExpressionsRule.Config {
            MyCalcReduceExpressionsRuleConfig DEFAULT = ImmutableMyCalcReduceExpressionsRuleConfig.of()
                    .withMatchNullability(true)
                    .withOperandFor(LogicalCalc.class)
                    .withDescription("ReduceExpressionsRule(Calc)")
                    .as(MyCalcReduceExpressionsRuleConfig.class);

            @Override default MyCalcReduceExpressionsRule toRule() {
                return new MyCalcReduceExpressionsRule(this);
            }
        }
    }

    /** Rule that reduces constants inside a {@link Window}.*/
    public static class MyWindowReduceExpressionsRule
            extends MyReduceExpressionsRule<MyWindowReduceExpressionsRule.MyWindowReduceExpressionsRuleConfig> {
        /** Creates a MyWindowReduceExpressionsRule. */
        protected MyWindowReduceExpressionsRule(MyWindowReduceExpressionsRuleConfig config) {
            super(config);
        }

        @Deprecated // to be removed before 2.0
        public MyWindowReduceExpressionsRule(Class<? extends Window> windowClass,
                                           boolean matchNullability, RelBuilderFactory relBuilderFactory) {
            this(MyWindowReduceExpressionsRuleConfig.DEFAULT.withRelBuilderFactory(relBuilderFactory)
                    .as(MyWindowReduceExpressionsRuleConfig.class)
        ...
        /** Rule configuration. */
        @Value.Immutable
        public interface MyWindowReduceExpressionsRuleConfig extends MyReduceExpressionsRule.Config {
            MyWindowReduceExpressionsRuleConfig DEFAULT = ImmutableMyWindowReduceExpressionsRuleConfig.of()
                    .withMatchNullability(true)
                    .withOperandFor(LogicalWindow.class)
                    .withDescription("ReduceExpressionsRule(Window)")
                    .as(MyWindowReduceExpressionsRuleConfig.class);

            @Override default MyWindowReduceExpressionsRule toRule() {
                return new MyWindowReduceExpressionsRule(this);
            }
        }
    }
    ...
    /** Creates a MyReduceExpressionsRule. */
    protected MyReduceExpressionsRule(C config) {
        super(config);
    }
    ...
    protected static boolean reduceExpressionsInternal(RelNode rel,
        ...
        // and the presence of casts could hinder other rewriter.rules such as sarg
    ...
    protected static class ReducibleExprLocator extends RexVisitorImpl<Void> {
        ...
        @Override public Void visitSubQuery(RexSubQuery subQuery) {
            // Reduction of RexSubQuery throws exception!
            analyzeCall(subQuery, Constancy.NON_CONSTANT);
            return null;
        }
    ...
    public interface Config extends RelRule.Config {
        @Override MyReduceExpressionsRule<?> toRule();
