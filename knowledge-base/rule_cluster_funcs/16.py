...
def can_be_optimized_by_limit(sql_query, table_schema=None, indexes=None, dialect=None):
    """
    Checks if the SQL query can be optimized by using LIMIT
    ...
    return len(list(parsed_query.find_all(exp.Limit))) > 0