...
def can_be_optimized_by_distinct(sql_query, table_schema=None, indexes=None, dialect=None):
    """
    Checks if the SQL query can be optimized by DISTINCT
    ...
    return len(list(parsed_query.find_all(exp.Distinct))) > 0